    ...
    val carList = listOf(
        ...
        Car(
           ...
           title = "A M DB11",
            ...
            carImage = R.drawable.amd
        ),
        Car(
            id = 3,
            title = "Mercedes-AMG",
            description = "Mobil sport terbaik ini menggunakan mesin 4.0 Liter Twih-Turbo V8 yang terhbung dengan transmisi otomatis dual-clutch tujuh percepatan yang nantinya bisa menghasilkan tenaga mencapai 550 Horsepower. Walaupun tidak secepat Buggati Chiron, namun Mercedes-AMG GT memiliki desain sangat sporty dan dibekali beragam fitur unggulan, seperti suspensi yang bisa diatur ketinggiannya, rear-axle steering, dan bodi aerodinamis yang membuatnya bisa berakselerasi sangat cepat dalam hitungan detik.",
            carImage = R.drawable.amg
        ),
        Car(
            id = 4,
